...
class PulsingWave extends StatefulWidget {
  const PulsingWave({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _PulsingWaveState createState() => _PulsingWaveState();
}
...
class _PulsingWaveState extends State<PulsingWave>
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onHorizontalDragDown: (details) => const Menu(),
      child: Scaffold(
        backgroundColor: const Color(0xff312b47),
        body: Center(
          child: CustomPaint(
            painter: MyPainter(
